...
@section('header_title', 'Tambah Dokumen Baru')
@section('header_subtitle', 'Masukkan data berkas EXIM yang diserahkan untuk tanda tangan')
...
<div class="card" style="max-width: 800px; margin: 0 auto; position: relative; overflow: hidden;">
    ...
    <div style="margin-bottom: 30px; padding: 18px 24px; background: rgba(255, 255, 255, 0.01); border: 1px solid var(--glass-border); border-radius: var(--radius-lg); display: flex; align-items: center; justify-content: space-between; gap: 20px; backdrop-filter: blur(5px);">
        <div>
            <h4 style="font-family: var(--font-heading); font-size: 14px; font-weight: 700; color: var(--text-primary);">Preview Status Otomatis</h4>
            <p style="font-size: 12px; color: var(--text-muted); margin-top: 2px;">Status di bawah ini dikalkulasi secara real-time berdasarkan tanggal yang Anda input.</p>
        </div>
        <div id="live-status-badge">
            <span class="badge badge-warning" style="font-size: 13px; padding: 8px 16px; box-shadow: 0 0 15px rgba(245, 158, 11, 0.2);"><i class="bi bi-hourglass-amber"></i> Menunggu TTD (0 Hari)</span>
        </div>
    </div>
    ...
    <form action="{{ route('documents.store') }}" method="POST">
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <div style="position: relative;">
                    <input type="text" name="no_aju" id="no_aju" class="form-control @error('no_aju') is-invalid @enderror" placeholder="Contoh: AJU-2026-0719" value="{{ old('no_aju') }}" required style="padding-left: 45px;">
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <div style="position: relative;">
                    <input type="date" name="tgl_diserahkan" id="tgl_diserahkan" class="form-control @error('tgl_diserahkan') is-invalid @enderror" value="{{ old('tgl_diserahkan', date('Y-m-d')) }}" required style="padding-left: 45px;">
            ...
            <!-- Tanggal Kembali -->
            <div class="form-group">
                <label for="tgl_kembali">Tanggal Kembali (Kosongkan jika pending)</label>
                <div style="position: relative;">
                    <input type="date" name="tgl_kembali" id="tgl_kembali" class="form-control @error('tgl_kembali') is-invalid @enderror" value="{{ old('tgl_kembali') }}" style="padding-left: 45px;">
        ...
        <div class="form-group">
            ...
            <div style="position: relative;">
                <textarea name="catatan" id="catatan" class="form-control @error('catatan') is-invalid @enderror" placeholder="Tuliskan catatan tambahan mengenai berkas ini..." style="padding-left: 45px;">{{ old('catatan') }}</textarea>
        ...
        <div class="form-actions">
            ...
            <button type="submit" class="btn btn-primary">
                <i class="bi bi-save-fill"></i> Simpan Dokumen
            </button>
        </div>
    </form>
</div>
